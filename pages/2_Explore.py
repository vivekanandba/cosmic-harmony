...
st.markdown("<h4 style='text-align: center;'>If on mobile turn to landscape to explore this page better</h4>", unsafe_allow_html=True)
st.divider()
...
st.divider()
st.markdown("<h2 style='text-align: center;'>Meteorites with size across time - Globe View</h2>", unsafe_allow_html=True)
